...
export default function UploadProgram() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/program', { // Assuming backend runs on port 5000
        method: 'POST',
        headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || 'Gagal mengupload program');
      }
      ...
      setSuccessMessage('Program berhasil diupload!');
      ...
      setErrorMessage(`Gagal mengupload program: ${error.message || 'Terjadi kesalahan.'}`); // Set error message
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-blue-500">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Upload Program</h1>
              <p className="text-gray-600 text-sm">Tambahkan dokumentasi program Diskominfo</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              placeholder="Jelaskan detail program, tujuan, peserta, dan hasil yang dicapai..."
              rows={6}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
              required
            />
            <p className="text-xs text-gray-500 mt-1">Jelaskan program secara lengkap dan detail</p>
          </div>
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
              ...
              Foto Program <span className="text-gray-400">(Opsional)</span>
            </label>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Pastikan nama program jelas dan deskriptif</li>
            <li>• Deskripsi sebaiknya mencakup tujuan, peserta, dan hasil program</li>
